var page = null;
var action = null;
var confirmButtonContainerHandle = null;
...
function confirmButtonAdd() {
    ...
    let removeFormContainerElements = document.getElementById("innerFormContainer");
...
function setFormContainerAdd() {
    ...
    innerFormContainer.appendChild(addForm);
}
...
function setFormContainerDelete(data) {
    ...
    inerFormContainer.appendChild(deleteForm);
    index = data.index;
    confirmButtonHandle = document.getElementById("confirmButton");
...
function setFormContainerGetRequest() {
    ...
    innerFormContainer.appendChild(getRequestForm);
}
...
function setFormContainerEdit(data) {
    ...
    innerFormContainer.appendChild(editForm);
    index = data.index;
    confirmButtonHandle = document.getElementById("confirmButton");
...
function setFormContainer(setPage, setAction) {
    if(page == setPage && action == setAction)
        return;
    if(page == null) {
        let confirmButton = document.createElement("button");
        confirmButton.setAttribute("id", "confirmButton");
        confirmButton.innerHTML = "confirm action";
        confirmButtonContainerHandle.appendChild(conformButton);
        confirmButtonHandle = document.getElementById("confirmButton");
        confirmButtonHandle.addEventListener("click", handleConfirmButtonEvent);
    }
    else if(page != setPage || action != setAction) {
        if(page == "upcomingEvents")
    }
    page = setPage;
    action = setAction;
...
function formSubmitUpcomingEventsAdd() {
    if(page == "upcomingEvents" && action == "add")
        return;
...
var confirmButtonContainerHandle = document.getElementById("confirmButtonContainer");
